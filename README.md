...
* Demo [simple-float ](http://127.0.0.1:8080/src/content/getusermedia/simple-float/)
* http://127.0.0.1:8080/src/content/getusermedia/

This project is adapted from the WebRTC JavaScript code samples, with custom UI and workflow changes to support the recording studio experience here.
